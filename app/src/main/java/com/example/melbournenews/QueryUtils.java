...
public final class QueryUtils {
    ...
    private static List<News> extractFeatureFromJson(String newsJSON) {
        ...
        // Create an empty ArrayList that we can start adding news details to
        ...
        try {
            ...
            for (int i = 0; i < newsArray.length(); i++) {
                ...
                try {
                    authorName = newsObj.getJSONArray("references").
                            getJSONObject(0).
                            getString("author");
                ...
                //Extract the thumbnail image for the news item
                String thumbnail = "";

                try {
                    thumbnail = newsObj.getJSONObject("fields").
                            getString("thumbnail");
                } catch (JSONException e) {
                    Log.e(LOG_TAG, "Problem getting thumbnail of article", e);
                }


                // Create a new {@link News} object with the title, section,
                // author, date and url from the JSON response.
                News news1 = new News(title, section, authorName, date, webUrl, thumbnail);

                // Add the new {@link news1} to the list of News.
                news.add(news1);
            }
